    ...
    <div class="container">
		...
		<div class="col-sm-4">
     	 ...
     	 <form name="form1"  action="insert.php" onsubmit="return validateForm()" method="post">
					...
					<input type="text" name="email" onblur="(showResult(this.value))" class="form-control"required /><div id="email_suggestion"></div></br>
					...
					<input type="submit" name="submit" value="Register" class="btn btn-success" action="admin_view.php"/>
				</form>
				</div>
		</div>
		<div class="col-sm-4">
